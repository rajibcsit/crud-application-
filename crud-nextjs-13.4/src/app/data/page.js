...
export default function page() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      axios.get("http://127.0.0.1:8000/api/lesson").then((res) => {
    ...
    <>
      <div className="container mt-5">
        ...
        <div className="flex justify-end">
          <a href="#" class="bg-gray-500 text-white font-bold py-2 px-4 rounded">
            Add Lesson
          </a>
        </div>
                  ...
                  <tbody>
                    {lessons.map((lesson) => (
                      <tr className="border-b dark:border-neutral-500" key={lesson.id}>
                        ...
                        <td className="whitespace-nowrap px-6 py-4  font-medium">Edit</td>
